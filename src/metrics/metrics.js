...
export default class Metrics {
  ...
  constructor(factory: MetricsFactory) {
    ...
    this.throttlerUpdateSuccess = this._factory.createCounter('jaeger:baggage_restrictions_updates', {
      result: 'ok',
    });

    this.throttlerUpdateFailure = this._factory.createCounter('jaeger:baggage_restrictions_updates', {
      result: 'err',
    });
  }
}
